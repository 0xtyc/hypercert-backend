...
import { getAllTransactionEvents, initializeMoralis } from '../../utils/moralis';
...
describe('Moralis functions', () => {
  ...
  it('should get transaction events from moralis', async () => {
    ...
    (Moralis.EvmApi.events.getContractEvents as jest.Mock).mockResolvedValue(mockResponse);
